...
setInterval(function () {
    ...
    let dateOfConcern = new Date('09 August 2021')
    let timeDiff = dateOfConcern.getTime() - currentDate.getTime()
    day.innerHTML = Math.floor(timeDiff / (1000 * 60 * 60 * 24))
    hour.innerHTML = Math.floor(timeDiff / (1000 * 60 * 60)) - Math.floor(timeDiff / (1000 * 60 * 60 * 24)) * 24
    min.innerHTML = Math.floor(timeDiff / (1000 * 60)) - Math.floor(timeDiff / (1000 * 60 * 60)) * 60
    sec.innerHTML = Math.floor(timeDiff / 1000) - Math.floor(timeDiff / (1000 * 60)) * 60
}, 1000)